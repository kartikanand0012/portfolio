...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Kartik Anand
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitile">Backend Developer</h3>
            <p className="home__description">
                I'm a creative Developer based in Chandigarh, and I'm very passionate and dedicated to my work
            </p>
